...
![Flexbox froggy screenshot](/images/flexbox_froggy.png)
...
+ Further reading:
  + [The obvious MDN explanation](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Flexible_Box_Layout/Using_CSS_flexible_boxes)
